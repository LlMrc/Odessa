      ...
      builder: (context, value, child) {
        ...
        switch (value) {
          ...
          case RepeatState.repeatPlaylist:
            icon = const Icon(Icons.repeat, color: Colors.red,);
            break;
        }
        return IconButton(
             iconSize: 20.0,
...
class CurrentSongTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<String>(
      ...
      builder: (_, title, __) {
        return SingleChildScrollView(child: Text(title, maxLines: 1,overflow: TextOverflow.fade, style: const TextStyle(fontSize: 16)));
      },
    );
  }
}
